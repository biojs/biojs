var tnt_theme_track_compact = function () {
    ...
    var gBrowserTheme = function (gB, div) {
        ...
        var ensGeneLabel = opts_pane
            ...
            .on("click", function () {
                toggle(d3.select("#tnt_" + div_id + "_ensGene_option"))
            });
        ...
        var orthologuesLabel = opts_pane
            ...
            .attr("class", "tnt_option_label")
            .on("click", function () {
                toggle(d3.select("#tnt_" + div_id + "_ortho_option"))
            });
        orthologuesLabel
            .append("img")
        ...
        var paraloguesLabel = opts_pane
            ...
            .attr("class", "tnt_option_label")
            .on("click", function () {
                toggle(d3.select("#tnt_" + div_id + "_para_option"))
            });
        paraloguesLabel
            .append("img")
        ...
        var searchLabel = opts_pane
            ...
            .attr("class", "tnt_option_label")
            .on("click", function () {
                toggle(d3.select("#tnt_" + div_id + "_search_option"))
            });
        searchLabel
            .append("img")
    ...
    var gene_info_cbak = function (gene) {
        ...
        sel.append("span")
            ...
            .text("[Close]")
            .on("click", function () {
                d3.select("#tnt_" + div_id + "_gene_info" + " p").remove();
