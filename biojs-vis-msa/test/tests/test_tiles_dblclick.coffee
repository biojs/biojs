...
test "test double click left", ->
  stageTest ->
    for startX in [testRangeStart..testRangeEnd] by testRangeStep
      ...
      assert.equal stage.viewportY,valY, "viewportY"
...
test "test double click middle", ->
  stageTest ->
    for startX in [testRangeStart..testRangeEnd] by testRangeStep
      ...
      assert.equal stage.viewportX, startX, "viewportX"
      assert.equal stage.viewportY, startX, "viewportY"
