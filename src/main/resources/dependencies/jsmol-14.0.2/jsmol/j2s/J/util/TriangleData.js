...
Clazz.load (["J.api.Triangulator", "JU.P3i"], "J.util.TriangleData", ["JU.AU", "$.BS", "$.P3", "J.util.BSUtil"], function () {
c$ = Clazz.declareType (J.util, "TriangleData", null, J.api.Triangulator);
$_V(c$, "intersectPlane", 
function (plane, v, flags) {
if (plane == null) {
v.addLast (J.util.TriangleData.fullCubePolygon);
return v;
...
if (values[i] < 0) insideMask |= J.util.TriangleData.Pwr2[i];
}
var triangles = J.util.TriangleData.triangleTable2[insideMask];
if (triangles == null) return null;
for (var i = 0; i < 24; i += 2) {
var v1 = J.util.TriangleData.edgeVertexes[i];
var v2 = J.util.TriangleData.edgeVertexes[i + 1];
...
var nPoints = J.util.BSUtil.cardinalityOf (bsPoints);
