...
J.util.Logger.info (nxttoplbl);
this.data = this.readFloatArray ();
J.util.Logger.info ("DelPhi data length: " + this.data.length);
var botlbl = this.readString ();
J.util.Logger.info (botlbl);
...
J.util.Logger.info ("DelPhi voxel counts: " + nx);
dx *= Clazz.doubleToInt ((nx - 1) / 2);
this.volumetricOrigin.set (scalemid[1], scalemid[2], scalemid[3]);
J.util.Logger.info ("DelPhi center " + this.volumetricOrigin);
