...
Clazz.load (["J.image.ImageEncoder"], "J.image.PdfEncoder", ["java.util.Hashtable", "javajs.export.PDFCreator"], function () {
c$ = Clazz.decorateAsClass (function () {
this.isLandscape = false;
this.pdf = null;
this.comment = null;
Clazz.instantialize (this, arguments);
}, J.image, "PdfEncoder", J.image.ImageEncoder);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, J.image.PdfEncoder, []);
});
$_V(c$, "setParams", 
function (params) {
