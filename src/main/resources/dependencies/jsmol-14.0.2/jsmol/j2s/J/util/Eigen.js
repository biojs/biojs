...
$_M(c$, "getRealEigenvalues", 
function () {
return this.d;
});
$_M(c$, "getImagEigenvalues", 
function () {
return this.e;
});
$_M(c$, "getEigenvalues", 
...
$_M(c$, "getEigenvectorsFloatTransposed", 
function () {
...
var r = J.util.Eigen.hypot (p, 1.0);
if (p < 0) {
r = -r;
...
g = c * this.e[i];
h = c * p;
r = J.util.Eigen.hypot (p, this.e[i]);
this.e[i + 1] = s * r;
s = this.e[i] / r;
c = p / r;
p = c * this.d[i] - s * g;
