...
Clazz.load (null, "JSV.source.JSVXmlReader", ["java.lang.Character", "java.util.Hashtable", "JU.SB"], function () {
c$ = Clazz.decorateAsClass (function () {
this.thisEvent = null;
this.buffer = null;
if (!Clazz.isClassDefined ("JSV.source.JSVXmlReader.DataBuffer")) {
JSV.source.JSVXmlReader.$JSVXmlReader$DataBuffer$ ();
}
if (!Clazz.isClassDefined ("JSV.source.JSVXmlReader.DataString")) {
JSV.source.JSVXmlReader.$JSVXmlReader$DataString$ ();
}
if (!Clazz.isClassDefined ("JSV.source.JSVXmlReader.XmlEvent")) {
JSV.source.JSVXmlReader.$JSVXmlReader$XmlEvent$ ();
}
if (!Clazz.isClassDefined ("JSV.source.JSVXmlReader.Tag")) {
JSV.source.JSVXmlReader.$JSVXmlReader$Tag$ ();
}
Clazz.instantialize (this, arguments);
}, JSV.source, "JSVXmlReader");
Clazz.prepareFields (c$, function () {
this.thisEvent = Clazz.innerTypeInstance (JSV.source.JSVXmlReader.XmlEvent, this, null, 0);
});
Clazz.makeConstructor (c$, 
function (br) {
this.buffer = Clazz.innerTypeInstance (JSV.source.JSVXmlReader.DataBuffer, this, null, br);
...
c$.$JSVXmlReader$DataBuffer$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);
}, JSV.source.JSVXmlReader, "DataBuffer", JSV.source.JSVXmlReader.DataString, null, Clazz.innerTypeInstance (JSV.source.JSVXmlReader.DataString, this, null, Clazz.inheritArgs));
Clazz.makeConstructor (c$, 
function (a) {
Clazz.superConstructor (this, JSV.source.JSVXmlReader.DataBuffer, []);
this.reader = a;
}, "java.io.BufferedReader");
$_M(c$, "hasNext", 
function () {
...
if (Clazz.exceptionOf (e, Exception)) {
return Clazz.innerTypeInstance (JSV.source.JSVXmlReader.XmlEvent, this, null, 8);
} else {
throw e;
}
}
var a = this.ptr;
var b = Clazz.innerTypeInstance (JSV.source.JSVXmlReader.XmlEvent, this, null, this);
this.ptr = a;
return b;
});
$_M(c$, "nextTag", 
...
this.flush ();
this.skipTo ('<', false);
var a = Clazz.innerTypeInstance (JSV.source.JSVXmlReader.XmlEvent, this, null, this);
return a;
});
$_M(c$, "nextEvent", 
function () {
this.flush ();
return Clazz.innerTypeInstance (JSV.source.JSVXmlReader.XmlEvent, this, null, this);
});
c$ = Clazz.p0p ();
};
c$.$JSVXmlReader$DataString$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
this.data = null;
...
this.ptEnd = 0;
Clazz.instantialize (this, arguments);
}, JSV.source.JSVXmlReader, "DataString");
Clazz.makeConstructor (c$, 
function () {
this.data =  new JU.SB ();
});
...
c$.$JSVXmlReader$XmlEvent$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
this.eventType = 0;
...
this.data = null;
Clazz.instantialize (this, arguments);
}, JSV.source.JSVXmlReader, "XmlEvent");
$_V(c$, "toString", 
function () {
...
this.tag = Clazz.innerTypeInstance (JSV.source.JSVXmlReader.Tag, this, null, c);
...
var a = Clazz.innerTypeInstance (JSV.source.JSVXmlReader.DataString, this, null,  new JU.SB ().append (this.text));
try {
