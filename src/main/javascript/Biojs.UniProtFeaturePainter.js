/**
 * UniProt Cartoon - Graphical representations for features
 * @author ljgarcia
 */
 ...
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/jquery/jquery-1.4.2.min.js"></script>
 *
 * @requires <a href='http://jquery.bassistance.de/tooltip/jquery.tooltip.js'>jQuery.tooltip</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/jquery/jquery.tooltip.js"></script>
 *
 * @requires <a href='https://github.com/brandonaaron/bgiframe/blob/master/jquery.bgiframe.js'>jQuery.bgiframe</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/jquery/jquery.bgiframe.js"></script>
 *
 ...
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/jquery/jquery.delegate.js"></script>
 *
 ...
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/jquery/jquery.dimensions.js"></script>
 *
 * @requires <a href='https://github.com/allmarkedup/jQuery-URL-Parser/blob/master/jquery.url.js'>jQuery.url</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/jquery/jquery.url.js"></script>
 *
 * @requires <a href='http://github.com/DmitryBaranovskiy/raphael/raw/master/raphael-min.js'>raphael</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/raphael.js"></script>
 *
 * @requires <a href='http://code.google.com/p/canvg/source/browse/trunk/canvg.js'>canvg</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/canvg.js"></script>
 *
 * @requires <a href='http://code.google.com/p/canvg/source/browse/trunk/rgbcolor.js'>rgbcolor</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/rgbcolor.js"></script>
 *
 * @requires <a href='https://github.com/allmarkedup/jQuery-URL-Parser/blob/master/jquery.url.js'>flashcanvas</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/jquery/jquery.url.js"></script>
 *
 * @requires <a href='http://code.google.com/p/flashcanvas/source/browse/trunk/bin/flashcanvas.swf'>flashcanvas.swf</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/dependencies/flashcanvas.swf"></script>
 *
 * @requires <a href='https://github.com/sampula/SVG.toDataURL/blob/master/svg_todataurl.js'>svg-todataurl</a>
 * @dependency <script language="JavaScript" type="text/javascript" src="../resources/svg-todataurl.js"></script>
 *
...
/** @lends Biojs.UniProtFeaturePainter */
{
    ...
    eventTypes: [
         ...
         *       console.log(obj.shape); //raphaël object
         *    }
         * );
         *
         * */
     ...
     * @param rdbStyle Radio buttons grouping styles, possible values: nonOverlapping, rows, centered.
     * @param chkHorizontal Check button for horizontal grid lines.
     * @param chkVertical Check button for vertical grid lines.
     */
...
//        printWin.close();
     ...
     * @param withoutZoom When true, it sets to 0 the total count for all feature types.
     */
     ...
     * @param withoutZoom When true, this method recalculates the total for each feature type.
     */
    ...
    _paintSlider: function() {//holder size, left and right margins of the holder, and number of amino acids
        if (this.opt.showSlider == true) {
            ...
            var myself = this;
            this.zoomSlider = jQuery('<div style="width:300px"></div>').appendTo(slider_div);
     ...
     * @param withoutZoom When false, it zooms according to the slider values.
     * @param newStart Zoom from this sequence start value.
     * @param newStop Zoom to this sequence end value.
     */
     ...
     * @param sizeX Width.
     * @param sizeY Height for the features holder.
     * @param sizeYKey Height for the legend.
     */
     ...
     * @param obj SVG representation for features.
     * @param sequenceLineY Y position for the sequence line.
     */
     ...
     * @param el Element whose x, y, and width needs to be recalculated according to the new zoom.
     */
     ...
     * @param horizontalGrid Should horizontal lines be painted?
     * @param horizontalGridNumLines Number of horizontal grid lines to be painted.
     * @param gridLineHeight Pixels separation between lines.
     * @param nonOverlapping Is nonOverlapping style selected?
     * @param leftMargin Pixels to left margin.
     * @param rightMargin Pixels to right margin.
     * @param sequenceLineY Y position for the sequence line.
     * @param rulerY Y position for the ruler.
     * @param sizeX Width.
     * @param raphael SVG features representation.
     */
     ...
     * @param verticalGridLineLength Vertical grid line length.
     * @param stop Requested stop for the sequence.
     * @param start Requested start for the sequence.
     * @param rulerLength Ruler length.
     * @param rulerY Y position for the ruler.
     * @param pixelsDivision Pixels between amino acids.
     * @param leftMargin Pixels to left margin.
     * @param raphael SVG features representation.
     */
     ...
     * @param newStyle New style to be applied
     */
