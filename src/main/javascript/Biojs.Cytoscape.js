...
Biojs.Cytoscape = Biojs.extend(
	/** @lends Biojs.Cytoscape# */
	{
		 ...
		 */
		center: function(collection){return this.cytoscape.center(collection)},
		/**
		 ...
		 */
		fit: function(collection){return this.cytoscape.fit(collection)},
		/**
		 ...
		 */
		pan: function(renderedPosition){return this.cytoscape.pan(renderedPosition)},
		/**
		 ...
		 */
		panby: function(renderedPosition){return this.cytoscape.panby(renderedPosition)},
		/**
		 ...
		 * instance.reset();
		 */
		reset: function(){return this.cytoscape.reset()},
		/**
		 ...
		 */
		zoom: function(options){return this.cytoscape.zoom(options)},
		 ...
		 * <a target='_blank' href='https://github.com/cytoscape/cytoscape.js/wiki/Core-add'>Add</a> elements to the graph.
 		 ...
 		 * 
 		 * @example
 		 * instance.add({ group: "nodes", data: { id: "n0", position: { x: 100, y: 100 } } });
		 */
		add: function(options){return this.cytoscape.add(options)},
		/**
		 ...
		 */
		remove: function(options){return this.cytoscape.remove(options)},
		/**
		 ...
		 */
		load: function(options){return this.cytoscape.load(options)},
		/**
		 ...
		 */
		nodes: function(options){return this.cytoscape.nodes(options)},
		/**
		 ...
		 */
		edges: function(options){return this.cytoscape.edges(options)},
		/**
		 ...
		 */
		elements: function(options){return this.cytoscape.elements(options)},
		/**
		 ...
		 */
		filter: function(options){return this.cytoscape.filter(options)},
		/**
		 ...
		 */
		collection: function(){return this.cytoscape.collection()},
		 ...
		 */
		bind: function(options){return this.cytoscape.bind(options)},
		/**
		 ...
		 */
		unbind: function(options){return this.cytoscape.unbind(options)},
		/**
		 ...
		 */
		one: function(options){return this.cytoscape.one(options)},
		/**
		 ...
		 */
		trigger: function(options){return this.cytoscape.trigger(options)},
		 ...
		 */
		backgroundBind: function(options){return this.cytoscape.background().bind(options)},
		/**
		 ...
		 */
		backgroundUnbind: function(options){return this.cytoscape.background().unbind(options)},
		/**
		 ...
		 */
		backgroundOne: function(options){return this.cytoscape.background().one(options)},
		/**
		 ...
		 */
		backgroundTrigger: function(options){return this.cytoscape.background().trigger(options)}
});
