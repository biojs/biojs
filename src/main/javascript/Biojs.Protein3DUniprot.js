    ...
    /** @lends Biojs.Protein3DUniprot# */
    {
        constructor: function(options) {
    		...
    		if ( self._alignmentsJustArrived ) {
    			...
    			// Raise the event with the first pdb selected by default
    			var alignmentId = pdb;
...
//    			self.raiseEvent('onPdbSelected', { 
//    				pdbId: pdb,
//    				alignments: self.getAlignmentsByPdb(pdb)
//    			});
    ...
    */ 
	...
	getCurrentAlignmentId: function () {
		var selectedValue = $('#pdbFile_select').val();
    ...
    */ 
	removeSelection: function() { 
        ...
        setSelection: function(selection) {
            // TODO: Add an option to enable/disable the filtering code
            //var alignments = this._filterAligmentsBySelection(selection);
