...
function publish(symbolSet) {
	...
	try {
		...
		var methodsTemplate = new JSDOC.JsPlate(publish.conf.templatesDir+"registryMethods.tmpl");
		var eventsTemplate = new JSDOC.JsPlate(publish.conf.templatesDir+"registryEvents.tmpl");
		var optionsTemplate = new JSDOC.JsPlate(publish.conf.templatesDir+"registryOptions.tmpl");
	}
	catch(e) {
